...
export default function HiringSettings({
      ...
      <div className="rounded-lg bg-gray-800 p-6">
        ...
        <div className="py-8 text-center">
          ...
          <button
            ...
            className="rounded-md bg-yellow-600 px-6 py-2 text-white transition hover:bg-yellow-700 focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 focus:outline-none"
          >
            Upgrade Now
          </button>
        </div>
  ...
  return (
    <div className="rounded-lg bg-gray-800 p-6">
      <h2 className="mb-6 text-xl font-semibold text-white">Hiring Settings</h2>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex justify-end">
          <button
            ...
            className="cursor-pointer rounded-md bg-blue-600 px-6 py-2 text-white transition hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none disabled:opacity-50"
          >
