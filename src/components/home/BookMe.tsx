...
export default function BookMe() {
  ...
  return (
    <section className="px-4 py-20 sm:px-6 sm:py-24 md:px-8 lg:px-12 xl:px-20 2xl:px-40">
      <motion.div
        className="mx-auto max-w-7xl overflow-hidden rounded-2xl border border-white bg-(--charcoal-black) p-6 sm:p-8 md:p-10"
      ...
      >
        ...
        <h2 className="mb-4 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
          ...
          <motion.button
            ...
            className="mx-auto inline-flex items-center gap-2 rounded-lg bg-yellow-300 px-6 py-3 font-semibold text-black"
          >
            <Link
