...
declare global {
  ...
  // School-specific types (OrganizationFromDb, SchoolProfileFromDb, UTCollege,
  // UTDegreeType, UTSectorInterest, UTProfileData) live in
  // src/features/school/types.d.ts — ambient merge makes them available here too.
